...
OpenLayers.Control.LayerSwitcher =
    OpenLayers.Class(OpenLayers.Control, {
        ...
        redraw: function () {
            ...
            for (var i = 0, len = layers.length; i < len; i++) {
                ...
                if (layer.displayInLayerSwitcher) {
                    ...
                    opacityMinusButton.alt = "opaklık azalt";
                    opacityMinusButton.title = "opaklık azalt";
                    ...
                    opacityImg.alt = "opaklık";
                    opacityImg.title = "opaklık";
                    ...
                    opacityPlusButton.alt = "opaklık arttır";
                    opacityPlusButton.title = "opaklık arttır";
        ...
        onRemoveClick: function (e) {
            BelsisIMSMap.map.removeLayer(this.layer);
        ...
        onDownClick: function (e) {
            BelsisIMSMap.map.raiseLayer(this.layer, -1);
            if (e != null) {
                OpenLayers.Event.stop(e);
            }
        },
        ...
        */
        ...
        loadContents: function () {
            ...
            this.layersDiv.style.backgroundColor = "rgba(70, 61, 58, 0.26)";
